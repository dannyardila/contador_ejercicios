...
eFechaLimite=Label (ventana, text="Fecha limite: ",\
    bg=colorFondo, fg=colorLetra). place (x=20, y=160) 

botonAnadir=Button (ventana, text="Añadir libro",\
    command=anadir, bg="red", fg="black") .place (x=590,y=38)
...
botonLeido=Button (ventana, text="Libro ya leido",\
    command=eliminarLibro, bg="red",fg= "black") .place (x=528,y=448)

imgbtn=PhotoImage (file="salir2.png")

sal =Button (ventana, image=imgbtn, command=salir) .place (x=550, y=100)
